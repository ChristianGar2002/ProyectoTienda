<!--Modal para CRUD-->
<div class="modal fade" id="EliminarDatosEliminadosPorModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        ...
        <form action="eliminar_productos_eliminados_por2.php" class="text-center" method="POST">    
