<?php 
	...
	header("Content-Disposition:attachment;filename=reporte_productos_vendidos.xls");
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<table class="table text-center" style="border: 1px solid black; text-align: center; margin-right: auto;margin-left: auto;">
		<caption ><p style="font-size: 24px;"><b>Reporte de productos vendidos</b><br><p style="font-size: 20px;"><b>Fecha inicial: </b><?php echo $fecha_inicial ?> <b> Fecha final: </b><?php echo $fecha_final ?></p></p></caption>
		<tr class="thead-dark">
          ...
          <th style="font-size: 18px;background-color: #C6C6C6;">Total</th>
			...
			<?php
				...
				$sql="SELECT * FROM productos_vendidos WHERE fecha_registro BETWEEN '{$fecha_inicial}' AND '{$fecha_final}'";
