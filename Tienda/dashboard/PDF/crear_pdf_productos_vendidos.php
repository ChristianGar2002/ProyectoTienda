<?php 
	...
	include('pdf_mc_table_productos_vendidos.php');
...
//Cuerpo de la tabla	
	...
	$result = mysqli_query($connString, "SELECT * FROM productos_vendidos") or die("Error en la BD: ".mysqli_error($connString));
	$header = mysqli_query($connString, "SELECT * FROM productos_vendidos");
