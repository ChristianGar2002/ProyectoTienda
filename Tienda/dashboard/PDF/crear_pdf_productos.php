<?php 
	...
	include('pdf_mc_table_productos.php');
...
//Cuerpo de la tabla	
	...
	$result = mysqli_query($connString, "SELECT * FROM productos WHERE ACTIVO=1") or die("Error en la BD: ".mysqli_error($connString));
	$header = mysqli_query($connString, "SELECT * FROM productos WHERE ACTIVO=1");
...
foreach($result as $item){
	...
	$pdf->Row(Array(
		...
		utf8_decode($item['descripcion_producto']),
