<?php 
	...
	include('pdf_mc_table_productos_vendidos_fecha.php');
...
//Cuerpo de la tabla	
	...
	$result = mysqli_query($connString, "SELECT * FROM productos_vendidos WHERE fecha_registro BETWEEN '{$fecha_inicial}' AND '{$fecha_final}'") or die("Error en la BD: ".mysqli_error($connString));
	$header = mysqli_query($connString, "SELECT * FROM productos_vendidos WHERE fecha_registro BETWEEN '{$fecha_inicial}' AND '{$fecha_final}'");
