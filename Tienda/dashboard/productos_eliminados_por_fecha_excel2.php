<?php 
	...
	header("Content-Disposition:attachment;filename=productos_eliminados.xls");
...
<?php
//Capturamos las fechas enviadas por el formulario
...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<table class="table text-center" style="border: 1px solid black; text-align: center; margin-right: auto;margin-left: auto;">
		<caption ><p style="font-size: 24px;"><b>Reporte de productos eliminados</b><br><p style="font-size: 20px;"><b>Fecha inicial: </b><?php echo $fecha_inicial ?> <b> Fecha final: </b><?php echo $fecha_final ?></p></p></caption>
		<tr class="thead-dark">
          ...
          <th style="font-size: 18px;background-color: #C6C6C6;">Fecha de eliminacion</th>
          ...
          <th style="font-size: 18px;background-color: #C6C6C6;">Total de venta</th>
			...
			<?php
				...
				$sql="SELECT * FROM productos WHERE ACTIVO=2 AND fecha_eliminacion BETWEEN '{$fecha_inicial}' AND '{$fecha_final}'";
			...
			<tr style="text-align: center; font-size: 13px;">
				...
				<!--Codigo para encontrar el nombre de la categoria -->
            ...
            while ($fila2=mysqli_fetch_array($ejecutar2)) { ?>
				...
				<td style="font-size: 16px;"><?php echo $fila[8]?></td>
