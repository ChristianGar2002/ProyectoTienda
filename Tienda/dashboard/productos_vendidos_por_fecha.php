<!--Modal para CRUD-->
<div class="modal fade" id="ProductosVendidosFechaEXCELModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <form action="productos_vendidos_por_fecha_excel2.php" class="text-center" method="POST">    
