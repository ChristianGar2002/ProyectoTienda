...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<table class="table text-center" style="border: 1px solid black; text-align: center; margin-right: auto;margin-left: auto;">
		<caption ><p style="font-size: 24px;"><b>Reporte de productos eliminados</b><br><p style="font-size: 20px;"><b>Fecha: </b><?php echo $fecha_reporte ?></p></p></caption>
		<tr class="thead-dark">
          ...
          <th style="font-size: 18px;background-color: #C6C6C6;">Total de venta</th>
			...
			<?php
				...
				$sql="SELECT * FROM productos WHERE ACTIVO=2";
