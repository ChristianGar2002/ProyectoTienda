...
?>
<div class="modal fade" id="ActualizarProductoEliminadoModal<?php echo $data['codigo_producto']; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">

<?php
    $codigo_producto = $data['codigo_producto'];

    $sql6= "SELECT * FROM productos WHERE codigo_producto = {$codigo_producto} and ACTIVO='2'";
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header text-center bg-success" style="text-align: center;">
                <h5 class="modal-title text-white text-center" id="exampleModalLabel">Actualizar producto eliminado</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span>
                </button>
            </div>
        <form action="actualizar_producto_eliminado2.php" method="POST">    
