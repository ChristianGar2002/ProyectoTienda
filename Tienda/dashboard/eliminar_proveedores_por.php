<!--Modal para CRUD-->
<div class="modal fade" id="EliminarDatosProveedoresPorModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-sm" role="document">
        ...
        <form action="eliminar_proveedores_por2.php" class="text-center" method="POST">    
            <div class="modal-body">
                <div class="form-group text-center">
                   <select name="campo" id="servicio" class="form-control text-center" placeholder="Ingresa el campo correspondiente" required>
