<!--Modal para CRUD-->
<div class="modal fade" id="ProductosEliminadosFechaPDFModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <form action="PDF/reporte_productos_eliminados_fecha.php" class="text-center" method="POST">    
