...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
	<table class="table text-center" style="border: 1px solid black; text-align: center;">
		<caption ><p style="font-size: 24px;"><b>Reporte de usuarios</b><br><p style="font-size: 20px;"><b>Fecha: </b><?php echo $fecha_reporte ?></p></p></caption>
		<tr class="thead-dark">
          <th style="font-size: 18px;background-color: #C6C6C6;">ID</th>
          <th style="font-size: 18px;background-color: #C6C6C6;">Nombre completo</th>
          <th style="font-size: 18px;background-color: #C6C6C6;">Nombre de usuario</th>
          <th style="font-size: 18px;background-color: #C6C6C6;">Contraseña</th>
          <th style="font-size: 18px;background-color: #C6C6C6;">Correo</th>
          <th style="font-size: 18px;background-color: #C6C6C6;">Rol</th>
