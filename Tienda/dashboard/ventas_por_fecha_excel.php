<!--Modal para CRUD-->
<div class="modal fade" id="VentasFechaEXCELModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        ...
        <form action="ventas_fecha_excel.php" class="text-center" method="POST">    
            <div class="modal-body">
                <div class="form-group text-center">
                    <label style="font-size: 16px;"><b>Inicio de fecha:</b></label>
                    <input type="date" class="form-control text-center" name="fecha_inicial" placeholder="Ingrese la primera fecha" required>
                </div>
                <div class="form-group text-center">
                    <label style="font-size: 16px;"><b>Final de fecha:</b></label>
